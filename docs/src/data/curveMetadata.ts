...
export const curveMetadata: Record<string, CurveMetadata> = {
	...
	deltoid: {
		...
		description: "A three-cusped hypocycloid formed by a point on the circumference of a circle rolling inside a larger circle."
	},
	astroid: {
		id: "astroid",
		name: "Astroid",
	...
	rose5: {
		...
		family: "Rose",
		equation: "r = cos(5θ)",
		description: "A five-petaled rose curve, exploring how mathematical parameters create natural beauty."
	},
	lissajous43: {
		id: "lissajous43",
		name: "Lissajous 4:3",
		...
		description: "The harmonic dance of two perpendicular oscillations creates this mesmerizing curve family."
	},
	lissajous32: {
		id: "lissajous32",
		name: "Lissajous 3:2",
		...
		description: "A classic Lissajous figure where the 3:2 frequency ratio creates elegant looping patterns."
	},
	lame: {
		id: "lame",
		name: "Lamé Curve",
		...
		description: "A family of superellipses discovered by Gabriel Lamé in 1818, smoothly transitioning between squares and circles."
	}
};
...
export const morphPairsMetadata = [
	...
	},
	{
		from: "lame",
		to: "astroid",
		description: "From superellipse to hypocycloid — the smooth path between distinct curve families."
	}
];
