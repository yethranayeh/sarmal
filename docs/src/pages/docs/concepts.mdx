...
**Sarmal** /sɑːrˈmɑːl/ (*sar-MAHL*): From the Turkish word for *spiral*, *coil*. To define a path traced by a point moving through space.

> *Word formation:* The Turkish **sarmal** is built from the verb **sarmak** (to wrap, to coil) with the suffix `-al`, which forms nouns for the result of an action. So *sarmal* is literally 'that which is coiled' or 'the thing formed by winding.'
