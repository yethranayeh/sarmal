...
order: 6
description: Framework integration guides for React, Svelte, and CDN usage.
---
...
|------|------|---------|-------------|
| curve<span class="text-accent">*</span> | `CurveDef` | - | <strong class="text-accent">Required.</strong> The curve definition. Must be a stable reference (module-level const or `useMemo`). |
...
The quickest way to get a spinner on screen in Svelte 5:
...
| Prop | Type | Default | Description |
|------|------|---------|-------------|
| curve<span class="text-accent">*</span> | `CurveDef` | - | <strong class="text-accent">Required.</strong> The curve definition. Must be a stable reference (module-level const). |
...
| trailStyle | `TrailStyle` | `'default'` | `'default'` \| `'gradient-static'` \| `'gradient-animated'` |
| morphDuration | `number` | `300` | Duration of the morph transition when `curve` changes (ms) |
| instance | `SarmalInstance \| null` | - | <strong>Bindable.</strong> Use `bind:instance` to get the live `SarmalInstance`. |
...
Configure appearance and behavior through <code class="whitespace-nowrap">data-*</code> attributes on the canvas element:

| Attribute | Type | Example | Description |
|-----------|------|---------|-------------|
| data-sarmal<span class="text-accent">*</span> | `string` | `"rose3"` | <strong class="text-accent">Required.</strong> The built-in curve name. |
