...
The component renders a `<canvas>` element. You are responsible for sizing it - the canvas dimensions are captured at creation time and do not respond to CSS resizes.
