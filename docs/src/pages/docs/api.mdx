...
<SurgicalDemo concept="play-pause" />

### `pause()`

Pauses the animation loop (cancelAnimationFrame) and cancels any speed transition. State is preserved — `t`, trail, and speed are all maintained. Call `play()` to resume.
